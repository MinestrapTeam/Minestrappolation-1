...
public class BlockSandstoneBrick extends Block
{
    ...
    public static final String[] brickTextures = new String[] {"extradecor:block_SandstoneBrick", "extradecor:block_SandstoneBrickChiseled", "extradecor:block_SandstoneBrickMossy", "extradecor:block_SandstoneBrickHeiroglyph1", "extradecor:block_SandstoneBrickHeiroglyph2"};
