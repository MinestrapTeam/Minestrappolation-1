...
public class Block
{
    ...
    public static final Block bedrock = (new Block(7, Material.rock)).setHardness(80F).setResistance(6000000.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("bedrock").disableStats().setCreativeTab(CreativeTabs.tabBlock).func_111022_d("bedrock");
